# Semana 2 - Aula de Lógica 1
Este repositório corresponde à segunda semana de aula no curso em BackEnd pelo projeto Todas em Tech da iniciativa Reprograma. Neste momento iniciamos a sequência de aulas de Lógica em Programação com a professora Simara Conceição. A partir do readme apresentado no
repositório da aula é possível observar detalhadamente os assuntos apreendidos.

Neste reposítório há duas pastas com exemplos passados em sala durante as explicações, duas pastas com exercícios, onde uma foi desenvolvida com acompanhamento e outra sem.
...
## Avaliação pessoal sobre o aprendizado da semana:
